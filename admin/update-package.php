...
if(isset($_POST['submit']))
{
	...
	$sql="update TblTourPackages set PackageName=:pname, Duration=:pduration, PackageType=:ptype, GroupSize=:pgrpsize, TourGuide=:ptourguide, PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails, PackageImage=:pimage, Destination=:pdestination, DepatureTime=:pdepaturetime, ReturnTime=:preturntime, Included=:pincluded, Excluded=:pexcluded, TPDay1Tittle=:tpdayonetit, TPDay1Des=:tpdayonedes, TPDay2Tittle=:tpdaytwotit, TPDay2Des=:tpdaytwodes where PackageId=:pid";
						...
						{	?>
							...
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageduration" id="packageduration" placeholder="Create Package" value="<?php echo htmlentities($result->Duration);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagegrpsize" id="packagegrpsize" placeholder="Create Package" value="<?php echo htmlentities($result->GroupSize);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagetourguide" id="packagetourguide" placeholder="Create Package" value="<?php echo htmlentities($result->TourGuide);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagedestination" id="packagedestination" placeholder="Create Package" value="<?php echo htmlentities($result->Destination);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagedepaturetime" id="packagedepaturetime" placeholder="Create Package" value="<?php echo htmlentities($result->DepatureTime);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagereturntime" id="packagereturntime" placeholder="Create Package" value="<?php echo htmlentities($result->ReturnTime);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageincluded" id="packageincluded" placeholder="Create Package" value="<?php echo htmlentities($result->Included);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageexcluded" id="packageexcluded" placeholder="Create Package" value="<?php echo htmlentities($result->Excluded);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="tplandayonetit" id="tplandayonetit" placeholder="Create Package" value="<?php echo htmlentities($result->TPDay1Tittle);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="tplandayonedes" id="tplandayonedes" placeholder="Create Package" value="<?php echo htmlentities($result->TPDay1Des);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="tplandaytwotit" id="tplandaytwotit" placeholder="Create Package" value="<?php echo htmlentities($result->TPDay2Tittle);?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="tplandaytwodes" id="tplandaytwodes" placeholder="Create Package" value="<?php echo htmlentities($result->TPDay2Des);?>" required>
									</div>
								</div>
